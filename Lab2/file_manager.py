...
import random
from Lab2.constants import req_input_sorted, req_input_revsorted, req_input_random  # the required input for the project
...
def generate_sorted_file(length) -> [int]:
    ...
    """
    # the sorted dataset required input for the project
    if length == 50:
        return req_input_sorted
    else:
        initVal = 1000
        sorted_arr = []
...
def generate_reverse_sorted_file(length) -> [int]:
    ...
    """
    # the reverse sorted dataset required input for the project
    if length == 50:
        return req_input_revsorted
    else:
...
def generate_random_sorted_file(length) -> [int]:
    ...
    """
    # the random dataset required input for the project
    if length == 50:
        return req_input_random
    else:
        minVal = 1000
        maxVal = 9999
        rand_arr = []
